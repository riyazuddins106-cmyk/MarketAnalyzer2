...
for horizon in HORIZONS:
    ...
    for fold in range(FOLDS, 0, -1):
        ...
        # ----------------------------------------------------
        # v3.4.2 DIAGNOSTIC: INNER VALIDATION AUDIT
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # v3.4.2 DIAGNOSTIC: PERMUTATION / NULL TEST
        #
        # Calibration labels are randomly shuffled.
        # Validation labels remain untouched.
        #
        # This tests whether the rule-search process can
        # produce apparently strong validation rules even
        # when the calibration feature/outcome relationship
        # is destroyed.
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # v3.4.2 DIAGNOSTIC: RULE SEARCH STRUCTURE
        # ----------------------------------------------------
